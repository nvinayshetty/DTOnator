...
public class StringFieldRepresentorShould {
    ...
    public void CreatePublicFieldWhenAcessModifierIsPublic() {
        fieldName = "valid";
        String actual = new StringFieldRepresentor().getSimpleFieldRepresentationFor(AccessModifier.PUBLIC, fieldName);
    ...
    public void CreatePrivateFieldWhenAcessModifierIsPrivate() {
        fieldName = "valid";
        String actual = new StringFieldRepresentor().getSimpleFieldRepresentationFor(AccessModifier.PRIVATE, fieldName);
