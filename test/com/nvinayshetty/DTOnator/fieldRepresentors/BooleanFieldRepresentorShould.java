...
public class BooleanFieldRepresentorShould {
    ...
    public void CreatePublicFieldWhenAcessModifierIsPublic() {
        fieldName = "valid";
        String actual = new BooleanFieldRepresentor().getSimpleFieldRepresentationFor(AccessModifier.PUBLIC, fieldName);
    ...
    public void CreatePrivateFieldWhenAcessModifierIsPrivate() {
        fieldName = "valid";
        String actual = new BooleanFieldRepresentor().getSimpleFieldRepresentationFor(AccessModifier.PRIVATE, fieldName);
