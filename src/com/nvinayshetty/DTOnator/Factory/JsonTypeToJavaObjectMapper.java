...
public enum JsonTypeToJavaObjectMapper implements DtoHelper.primitiveConverter {
    BOOLEAN {
        ...
        public String getFieldRepresentationFor(String key) {
            ...
            return getAnnotationFor(key).append(ACCESS_MODIFIER_PUBLIC).append(className).append(SPACE).append(key).append(CLASS_FIELD_SUFFIX).toString();
        }
    }, JSON_ARRAY {
        @Override
        public String getFieldRepresentationFor(String key) {
    ...
    private static final String ACCESS_MODIFIER_PUBLIC = "public" + SPACE;
    private static final String ACCESS_MODIFIER_PRIVATE = "private" + SPACE;
    private static final String CLASS_FIELD_SUFFIX = ";\n";

    private static StringBuilder getAnnotationFor(String key) {
        return new StringBuilder().append(ANNOTATION_PREFIX).append(key).append(ANNOTATION_SUFFIX);
    }
}
