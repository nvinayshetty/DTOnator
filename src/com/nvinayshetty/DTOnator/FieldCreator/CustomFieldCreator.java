...
public class CustomFieldCreator  implements FieldCreationStrategy  {
    private String cutomFiledPattern;

    public CustomFieldCreator(String cutomFiledPattern) {

        this.cutomFiledPattern = cutomFiledPattern;
    }
    ...
    public String getFieldFor(LanguageType languageType, FieldRepresentor type, AccessModifier accessModifier, String key, FieldNameParser parser, NameConflictResolver nameConflictResolver) {
        return type.customFieldRepresentationTemplate(languageType,accessModifier,key,parser,nameConflictResolver,cutomFiledPattern);
    }
