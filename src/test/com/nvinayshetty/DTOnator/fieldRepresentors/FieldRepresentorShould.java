...
public class FieldRepresentorShould {
    ...
    public void createBooleanFieldRepresentation() {
        ...
        String actualBooleanField = fieldRepresentor.fieldCreationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, validSimpleFieldName, fieldNameParser, nameConflictResolver, keywordClassifier);
    ...
    public void createBooleanFieldRepresentationWithGsonAnnotations() {
        fieldRepresentor = new BooleanFieldRepresentor();
        String actualBooleanField = fieldRepresentor.gsonFieldRepresentationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, validSimpleFieldName, fieldNameParser, nameConflictResolver);
    ...
    public void createBooleanFieldRepresentationInCamelCaseWithGsonAnnotations() {
        ...
        String actualBooleanField = fieldRepresentor.gsonFieldRepresentationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, nameNotInCamelCase, fieldNameParser, nameConflictResolver);
    ...
    public void createBooleanFieldRepresentationShouldShowAnEroorNotification() {
        fieldRepresentor = new BooleanFieldRepresentor();
        String actualBooleanField = fieldRepresentor.gsonFieldRepresentationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, invalidIdentifier, fieldNameParser, nameConflictResolver);
    ...
    public void createBooleanFieldRepresentationInCamelCaseWithGsonAnnotationsShouldShowAnError() {
        ...
        fieldRepresentor = new BooleanFieldRepresentor();
        nameParserCommands.add(new CamelCase());
        String actualBooleanField = fieldRepresentor.gsonFieldRepresentationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, invalidIdentifierAfterCamelCasing, fieldNameParser, nameConflictResolver);
    ...
    public void createDoubleFieldRepresentation() {
        ...
        String actualDoubleField = fieldRepresentor.fieldCreationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, validSimpleFieldName, fieldNameParser, nameConflictResolver, keywordClassifier);
    ...
    public void createDoubleFieldRepresentationWithGsonAnnotations() {
        fieldRepresentor = new DoubleFieldRepresentor();
        String actualDoubleField = fieldRepresentor.gsonFieldRepresentationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, validSimpleFieldName, fieldNameParser, nameConflictResolver);
    ...
    public void createIntegerFieldRepresentation() {
        ...
        String actualIntegerField = fieldRepresentor.fieldCreationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, validSimpleFieldName, fieldNameParser, nameConflictResolver, keywordClassifier);
    ...
    public void createIntegerFieldRepresentationWithGsonAnnotation() {
        fieldRepresentor = new IntegerFieldRepresentor();
        String actualIntegerField = fieldRepresentor.gsonFieldRepresentationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, validSimpleFieldName, fieldNameParser, nameConflictResolver);
    ...
    public void createStringFieldRepresentation() {
        ...
        String actualStringField = fieldRepresentor.fieldCreationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, validSimpleFieldName, fieldNameParser, nameConflictResolver, keywordClassifier);
    ...
    public void createStringFieldRepresentationWithGsonAnnotation() {
        fieldRepresentor = new StringFieldRepresentor();
        String actualStringField = fieldRepresentor.gsonFieldRepresentationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, validSimpleFieldName, fieldNameParser, nameConflictResolver);
    ...
    public void createJsonObjectFieldRepresentation() {
        ...
        String actualJsonObjectField = fieldRepresentor.fieldCreationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, validSimpleFieldName, fieldNameParser, nameConflictResolver, keywordClassifier);
    ...
    public void createJsonObjectFieldRepresentationWithGsonAnnotation() {
        fieldRepresentor = new JsonObjectRepresentor();
        String actualJsonObjectField = fieldRepresentor.gsonFieldRepresentationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, validSimpleFieldName, fieldNameParser, nameConflictResolver);
    ...
    public void createJsonArrayFieldRepresentation() {
        ...
        String actualJsonArrayField = fieldRepresentor.fieldCreationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, validSimpleFieldName, fieldNameParser, nameConflictResolver, keywordClassifier);
    ...
    public void createJsonArrayFieldRepresentationWithGsonAnnotation() {
        ...
        jsonArrayRepresentor.setDataType(ObjectName);
        fieldRepresentor = jsonArrayRepresentor;
        String actualJsonArrayField = fieldRepresentor.gsonFieldRepresentationTemplate(LanguageType.JAVA, AccessModifier.PUBLIC, validSimpleFieldName, fieldNameParser, nameConflictResolver);
